#include "aeirobot_math/trajectory/trajectory_calculator.hpp"
...
namespace aeirobot
{
...

  {
    ...
    Eigen::Matrix<double, 3, 3> poly_matrix;
    Eigen::Matrix<double, 3, 1> poly_vector;
    ...
    Eigen::Matrix<double, Eigen::Dynamic, 1> time = Eigen::Matrix<double, Eigen::Dynamic, 1>::Zero(all_time_steps, 1);
    Eigen::Matrix<double, Eigen::Dynamic, 1> minimum_jerk_tra = Eigen::Matrix<double, Eigen::Dynamic, 1>::Zero(all_time_steps, 1);
...

  {
    ...
    Eigen::Matrix<double, Eigen::Dynamic, 1> time = Eigen::Matrix<double, Eigen::Dynamic, 1>::Zero(all_time_steps, 1);
    Eigen::Matrix<double, Eigen::Dynamic, 3> minimum_jerk_tra = Eigen::Matrix<double, Eigen::Dynamic, 3>::Zero(all_time_steps, 3);
  ...
  Eigen::Matrix<double, Eigen::Dynamic, 1> calcMinimumJerkTraWithViaPoints(int via_num,
                                                  double pos_start, double vel_start, double accel_start,
...

  {
    ...
    Eigen::Matrix<double, Eigen::Dynamic, 1> poly_vector = Eigen::Matrix<double, Eigen::Dynamic, 1>::Zero(3 * via_num + 3, 1);
    ...
    Eigen::Matrix<double, Eigen::Dynamic, 3> poly_matrix_part1 = Eigen::Matrix<double, Eigen::Dynamic, 3>::Zero(3 * via_num, 3);
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> poly_matrix_part2 = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>::Zero(3 * via_num, 3 * via_num);
    ...
    Eigen::Matrix<double, 3, Eigen::Dynamic> poly_matrix_part3 = Eigen::Matrix<double, 3, Eigen::Dynamic>::Zero(3, 3 * via_num + 3);
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> poly_matrix = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>::Zero(3 * via_num + 3, 3 * via_num + 3);
    ...
    Eigen::Matrix<double, Eigen::Dynamic, 1> poly_coeff = Eigen::Matrix<double, Eigen::Dynamic, 1>::Zero(3 * via_num + 3, 1);
    // C = A.inverse()*B;
    ...
    Eigen::Matrix<double, Eigen::Dynamic, 1> time_vector = Eigen::Matrix<double, Eigen::Dynamic, 1>::Zero(all_time_steps + 1, 1);
    ...
    Eigen::Matrix<double, Eigen::Dynamic, 1> via_time_vector = Eigen::Matrix<double, Eigen::Dynamic, 1>::Zero(via_num, 1);
    ...
    Eigen::Matrix<double, Eigen::Dynamic, 1> minimum_jerk_tra_with_via_points = Eigen::Matrix<double, Eigen::Dynamic, 1>::Zero(all_time_steps + 1, 1);
  ...
  Eigen::Matrix<double, Eigen::Dynamic, 1> calcMinimumJerkTraWithViaPointsPosition(int via_num,
                                                          double pos_start, double vel_start, double accel_start,
...

  {
    ...
    Eigen::Matrix<double, Eigen::Dynamic, 1> poly_vector = Eigen::Matrix<double, Eigen::Dynamic, 1>::Zero(via_num + 3, 1);
    ...
    Eigen::Matrix<double, Eigen::Dynamic, 3> poly_part1 = Eigen::Matrix<double, Eigen::Dynamic, 3>::Zero(via_num, 3);
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> poly_part2 = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>::Zero(via_num, via_num);
    ...
    for (i = 1; i <= via_num; i++)
    {
      for (j = 1; j <= via_num; j++)
      {
        ...
        poly_part2.coeffRef(j - 1, i - 1) = pow(
                                                (via_time.coeff(k - 1, 0) - via_time.coeff(i - 1, 0)), 5) /
                                            120;
      }
    }

    // Eigen::MatrixXd poly_part3 = Eigen::MatrixXd::Zero(3, via_num + 3);
    Eigen::Matrix<double, 3, Eigen::Dynamic> poly_part3 = Eigen::Matrix<double, 3, Eigen::Dynamic>::Zero(3, via_num + 3);
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> poly_matrix = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>::Zero(via_num + 3, via_num + 3);
    ...
    Eigen::Matrix<double, Eigen::Dynamic, 1> poly_inv_matrix = Eigen::Matrix<double, Eigen::Dynamic, 1>::Zero(2 * via_num + 3, 1);
    // C = A.inverse() * B;
                               ...
                               double rotation_angle, double cross_ratio)
  {
    ...
    Eigen::Matrix<double, Eigen::Dynamic, 1> angle_tra = calcMinimumJerkTra(0.0, 0.0, 0.0,
                                                                  rotation_angle, 0.0, 0.0,
                                                                  smp_time, mov_time);

    // Eigen::MatrixXd arc_tra = Eigen::MatrixXd::Zero(3, all_time_steps);
    Eigen::Matrix<double, 3, Eigen::Dynamic> arc_tra = Eigen::Matrix<double, 3, Eigen::Dynamic>::Zero(3, all_time_steps);
    ...
    for (int step = 0; step < all_time_steps; step++)
    {
      ...
      Eigen::Matrix<double, 3, 3> weight_wedge;
      ...
      Eigen::Matrix<double, 3, 3> rotation = identity + weight_wedge * sin(theta) + weight_wedge * weight_wedge * (1 - cos(theta));
    ...
    Eigen::Matrix<double, Eigen::Dynamic, 3> act_tra_trans = arc_tra.transpose();
