...
ThirdOrderTrajectoryGenerator::ThirdOrderTrajectoryGenerator()
{
  current_time = 0;
...
bool ThirdOrderTrajectoryGenerator::DetectChangeFinalValue(double pose_, double velocity_, double time_)
{
...
double ThirdOrderTrajectoryGenerator::GenerateThirdOrderTrajectory(double initial_value_, double final_value_,
