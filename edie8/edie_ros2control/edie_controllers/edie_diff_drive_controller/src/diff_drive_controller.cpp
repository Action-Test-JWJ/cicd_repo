...
namespace
{
constexpr auto DEFAULT_COMMAND_TOPIC = "/edie8/diff_drive_controller/cmd_vel";
constexpr auto DEFAULT_COMMAND_UNSTAMPED_TOPIC = "/edie8/diff_drive_controller/cmd_vel_unstamped";
constexpr auto DEFAULT_COMMAND_OUT_TOPIC = "/edie8/diff_drive_controller/cmd_vel_out";
constexpr auto DEFAULT_ODOMETRY_TOPIC = "/edie8/diff_drive_controller/odom";
constexpr auto DEFAULT_RESET_CONTROLLER_TOPIC = "/edie8/diff_drive_controller/reset_controller";
  ...
  const rclcpp_lifecycle::State &)
{
  ...
  reset_controller_subscriber_ = get_node()->create_subscription<std_msgs::msg::Empty>(
    DEFAULT_RESET_CONTROLLER_TOPIC, rclcpp::SystemDefaultsQoS(),
    [this](const std::shared_ptr<std_msgs::msg::Empty> msg) -> void
    {
      RCLCPP_INFO(get_node()->get_logger(), "Resetting controller");
