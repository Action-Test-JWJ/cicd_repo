...
class PPOagent(object):
    ...
    def train(self, max_episode_num, max_batch_size):
        ...
        for ep in range(int(max_episode_num)):
            ...
            percentage_action = action+1
            percentage_action = self.normalize_array(percentage_action)
            print("---------------------------------------------")
            print("action percentage: ")
            print(percentage_action)
            edie_action = np.random.choice(15, 1, p=percentage_action)
            print("---------------------------------------------")
            print("edie action: ")
            print(edie_action)
    ...
    def plot_result(self):
        ...
        self.png_name = self.file_path+'/../edie_rl_learn/edie_rl_learn/ppo_graph'+self.png_number_string+'.png'
