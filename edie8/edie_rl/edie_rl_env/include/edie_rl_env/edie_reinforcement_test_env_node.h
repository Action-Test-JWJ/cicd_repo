...
{
    public:
    Dummy(int state_number_, int action_number_, int state_sector_number_, int seed);
    ~Dummy();
...
namespace EDIE
{
    ...
    public: 
        ...
        Dummy *dummy_instance_1;
        Dummy *dummy_instance_2;
        Dummy *dummy_instance_3;
        Dummy *dummy_instance_4;
        Dummy *dummy_instance_5;
        Dummy *dummy_instance_6;
        Dummy *dummy_instance_7;
