...
Dummy::Dummy(int state_number_, int action_number_, int state_sector_number_, int seed)
{
    ...
    //action에 따라 어느 감정을 증가시킬지 결정할 table 생성결
...
bool EDIE::EDIE_reinforcement_env::StateServiceCallback([[maybe_unused]]std::shared_ptr<edie_msgs::srv::Reinforcement::Request> req, 
    ...
    res->state.push_back(state.at(0));
    res->result = true;
    return true;
}
bool EDIE::EDIE_reinforcement_env::ActionServiceCallback(std::shared_ptr<edie_msgs::srv::Reinforcement::Request> req, 
    ...
    if(max_state_index == 0){  //normal
        switch(max_next_state_index){
            case 0: reward = -0.20;  break;  //normal
            case 1: reward = +1.00;  break;  //happy
            case 2: reward = -0.60;  break;  //sad
            case 3: reward = -1.00;  break;  //angry
            case 4: reward = -0.40;  break;  //disgust
            case 5: reward = -0.80;  break;  //fear
            case 6: reward = +0.50;  break;  //surprise
        }
    }

    else if(max_state_index == 1){  //happy
        switch(max_next_state_index){
            case 0: reward = -0.20;  break;  //normal
            case 1: reward = +1.00;  break;  //happy
            case 2: reward = -0.60;  break;  //sad
    ...
    else if(max_state_index == 2){  //sad
        switch(max_next_state_index){
            case 0: reward = +0.50;  break;  //normal
            case 1: reward = +1.00;  break;  //happy
            case 2: reward = -0.33;  break;  //sad
            case 3: reward = -1.00;  break;  //angry
            case 4: reward = +0.25;  break;  //disgust
            case 5: reward = -0.66;  break;  //fear
            case 6: reward = +0.75;  break;  //surprise
        }
    }

    else if(max_state_index == 3){  //angry
        switch(max_next_state_index){
            case 0: reward = +0.64;  break;  //normal
            case 1: reward = +1.00;  break;  //happy
            case 2: reward = +0.32;  break;  //sad
            case 3: reward = -1.00;  break;  //angry
            case 4: reward = +0.48;  break;  //disgust
            case 5: reward = +0.16;  break;  //fear
            case 6: reward = +0.80;  break;  //surprise
        }
    }

    else if(max_state_index == 4){  //disgust
        switch(max_next_state_index){
            case 0: reward = +0.33;  break;  //normal
            case 1: reward = +1.00;  break;  //happy
            case 2: reward = -0.50;  break;  //sad
            case 3: reward = -1.00;  break;  //angry
            case 4: reward = -0.25;  break;  //disgust
            case 5: reward = -0.75;  break;  //fear
            case 6: reward = +0.66;  break;  //surprise
        }
    }

    else if(max_state_index == 5){  //fear
        switch(max_next_state_index){
            case 0: reward = +0.60;  break;  //normal
            case 1: reward = +1.00;  break;  //happy
            case 2: reward = +0.20;  break;  //sad
            case 3: reward = -1.00;  break;  //angry
            case 4: reward = +0.40;  break;  //disgust
            case 5: reward = -0.50;  break;  //fear
            case 6: reward = +0.80;  break;  //surprise
        }
    }

    else if(max_state_index == 6){  //surprise
        switch(max_next_state_index){
            case 0: reward = -0.32;  break;  //normal
            case 1: reward = +1.00;  break;  //happy
            case 2: reward = -0.64;  break;  //sad
            case 3: reward = -1.00;  break;  //angry
            case 4: reward = -0.48;  break;  //disgust
            case 5: reward = -0.80;  break;  //fear
            case 6: reward = -0.16;  break;  //surprise
        }
    }
    reward = reward*1;
    ...
    state.push_back(reaction_max_state_now);
...
bool EDIE::EDIE_reinforcement_env::DoneServiceCallback([[maybe_unused]]std::shared_ptr<edie_msgs::srv::Reinforcement::Request> req, 
    ...
    std::cout <<  "pub reward: " << info_msg.data[3] << std::endl;
