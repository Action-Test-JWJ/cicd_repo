...
namespace aeirobot
{
  SimpleTrapezoidalVelocityProfile::SimpleTrapezoidalVelocityProfile()
  {
    ...
    pos_coeff_accel_section_.setZero();
    vel_coeff_accel_section_.setZero();
    pos_coeff_const_section_.setZero();
    vel_coeff_const_section_.setZero();
    pos_coeff_decel_section_.setZero();
    vel_coeff_decel_section_.setZero();
