...
#include "aeirobot_math/trajectory/fifth_order_trajectory_generate.h"
...
double FifthOrderTrajectory::GenerateFifthOderTrajectory(double initial_value_, double final_value_,
...
double FifthOrderTrajectory::GenerateOneFifthOderTrajectory(Eigen::MatrixXd joint_)
{
